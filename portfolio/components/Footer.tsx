...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.297-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.807.875 1.297 2.026 1.297 3.323s-.49 2.448-1.297 3.323c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.297h-1.829c-.319 0-.58-.261-.58-.58s.261-.58.58-.58h1.829c.319 0 .58.261.58.58s-.261.58-.58.58zm-5.262 4.644c-.319 0-.58-.261-.58-.58s.261-.58.58-.58.58.261.58.58-.261.58-.58.58zm0-2.829c-.319 0-.58-.261-.58-.58s.261-.58.58-.58.58.261.58.58-.261.58-.58.58z"/>
        </svg>
      )
    }
  ];
