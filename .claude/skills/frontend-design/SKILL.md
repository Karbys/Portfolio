...
- Section labels: small (0.7rem), uppercase, letterspaced (0.15em+), muted color â€” like "001 / Features"
...
- Text sits directly on the background â€” clean, confident, editorial
...
### Color Zones
- Background color must shift between sections (light â†’ dark â†’ accent â†’ light)
...
1. **Centered** â€” hero sections, CTAs
2. **Left-aligned** â€” feature descriptions with product on right
3. **Right-aligned** â€” alternate features
4. **Full-width** â€” horizontal marquee text, stats rows
5. **Split** â€” text on one side, supporting visual on the other
...
- Sequence: label first â†’ heading â†’ body text â†’ CTA/button
